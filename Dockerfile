...
ENV SONAR_APPLE_PLUGIN_VERSION=0.3.0
...
ADD --chown=sonarqube:sonarqube https://github.com/insideapp-oss/sonar-apple/releases/download/${SONAR_APPLE_PLUGIN_VERSION}/sonar-apple-plugin-${SONAR_APPLE_PLUGIN_VERSION}.jar /opt/sonarqube/extensions/plugins/
